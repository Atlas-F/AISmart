...
​	**简介**：一个AI智能助手，小型嵌入式智能助手设备，接入目前主流的Deepseek大模型，配备350*350分辨率屏幕，时间日期显示，触摸屏，对话面板
...
AISmart/UBSDL-lvgl/			（AISmart/Armfb-lvgl/  版本下有cjson.c和cjson.h）
...
- 已知问题
  ...
  - 对话的循环逻辑是死的，只能强制退出
  - ARM架构找不到库文件，已经发送到开发板上了，但是开发板找不到
